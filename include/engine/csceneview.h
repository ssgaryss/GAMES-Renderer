...
public:
    ...
    void loadShader(const char* vVertexShaderPath, const char* vFragmentShaderPath, EMaterial vMaterial);
    CShader selectShader(EMaterial vTarget); //寻找对应Shader
protected:
